...
public class StreamFilter {
    ...
    public StreamFilter() {
        this(PersonFactory.createPersonStream(100), randomCapitalLetter());
    }

    private static Character randomCapitalLetter() {
    ...
    public List<Person> toListOneLine() {
        return personStream.filter(Predicate.isEqual(startingCharacter)).collect(Collectors.toList());
    }
